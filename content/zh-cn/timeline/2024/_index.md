...
- **编码能力被基准逼着涨。** Claude 3（3 月）、3.5 Sonnet（6 月）以及 10 月的 Sonnet 升级，把 SWE-bench Verified 从约三分之一拉到约一半（厂商自报 49%）。分数会刷、会挑子集，但方向清楚：决策核心第一次在「修真实 GitHub issue」上拿出可引用的成绩。
